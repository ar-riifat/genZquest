				...
				<div class="container">
					...
					<div class="nav-mini-wrapper">
						<ul class="nav-mini sign-in">
							...
							<li><a href="employerhome.php">Profile</a></li>
						</ul>
					</div>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										<li  class="active">
											<a href="employerhome.php"><i class="fa fa-user"></i> Profile</a>
										</li>
										<li class="">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<form class="post-form-wrapper" action="update-profile.php" method="POST" autocomplete="off">
								
											<div class="row gap-20">
												<?php include 'check-reply.php'; ?>
												<div class="clear"></div>
										...
										<form action="new-dp.php" method="POST" enctype="multipart/form-data">
										<div class="row gap-20">
										<div class="col-sm-12 col-md-12">
										...
										?><a onclick = "return confirm('Are you sure you want to delete your logo ?')" class="btn btn-primary btn-inverse" href="drop-dp.php">Delete</a> <?php
										}
										?>
										</div>
										</div>
