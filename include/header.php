<nav class="navbar navbar-expand-lg navbar-dark bg-dark px-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href="category.php?search=VideoAnimation">Video & Animation</a></li>
...
if (isset($_SESSION['username'])) {
    ...
    if ($userData && $userData['preference'] == 'employer') {
...
<?php
  if (!isset($_SESSION['username'])) {
    echo "
      <li class='nav-item'>
        <a class='nav-link' href='#registerModal' data-bs-toggle='modal'><i class='bi bi-person'></i> Register</a>
      </li>
      <li class='nav-item'>
